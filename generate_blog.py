...
def save_generated_post(topic: str, article: dict[str, str], author: AuthorProfile) -> Path:
  ...
  static_html = "\n".join(
    [
      ...
      '        <a href="https://www.cryptobelastinggids.nl/" class="inline-flex items-center">',
      '          <svg viewBox="0 0 250 50" aria-label="CryptoBelastingGids" role="img" class="h-10 w-auto md:h-[50px]">',
      '            <g transform="translate(2,2)">',
      '              <rect x="0" y="0" width="46" height="46" rx="12" fill="#1E3A8A"></rect>',
      '              <path d="M10 31 L18 23 L24 27 L33 16" fill="none" stroke="#10B981" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"></path>',
      '              <circle cx="10" cy="31" r="2.2" fill="#10B981"></circle>',
      '              <circle cx="18" cy="23" r="2.2" fill="#10B981"></circle>',
      '              <circle cx="24" cy="27" r="2.2" fill="#10B981"></circle>',
      '              <circle cx="33" cy="16" r="2.2" fill="#10B981"></circle>',
      ...
      "            </g>",
      '            <text x="58" y="32" font-size="22" font-weight="700" fill="#1E3A8A" font-family="Inter, Arial, sans-serif">CryptoBelastingGids</text>',
      "          </svg>",
      "        </a>",
      ...
      '          <a href="https://www.cryptobelastinggids.nl/#gidsen" class="rounded-lg px-3 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">Gidsen</a>',
      '          <a href="https://www.cryptobelastinggids.nl/#artikelen" class="rounded-lg px-3 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">Artikelen</a>',
      '          <a href="https://www.cryptobelastinggids.nl/#over-ons" class="rounded-lg px-3 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">Over Ons</a>',
      "        </nav>",
      "      </div>",
      "    </header>",
      '    <main class="mx-auto max-w-4xl px-4 py-10 sm:px-6">',
      '      <article class="rounded-xl bg-white p-8 shadow-sm md:p-12">',
      f"        {title_h1}",
      f'        <img src="{image_url}" alt="Illustratie bij {html.escape(article["title"])}" loading="eager" decoding="async" />',
      f"        {body_core}",
      "      </article>",
      "    </main>",
      '    <footer id="over-ons" class="border-t border-slate-200 bg-white"><div class="mx-auto max-w-6xl px-4 py-8 text-sm text-slate-500 sm:px-6"><p>© CryptoBelastingGids. Alle rechten voorbehouden.</p></div></footer>',
      "  </body>",
      "</html>",
      "",
    ]
